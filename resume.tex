...
%  \vspace{.01in}
  ...
  \location{Albany, NY}
  \begin{position}
    I teach two undergraduate data classes classes. These classes teach
    practical analytical skills, data management, and R programming. Both
    classes include readings and discussions which called "Beyond the Numbers"
    which include topics such as bias in data, ethics in machine learning,
    HIPPA, etc.
    \newline
    \begin{itemize}
      ...
      course but introduces core project skills such as data management, data
      clean up, single table data transformations as well as linear and logistic
      regression.
  ...
  \begin{position}
    ...
    remote-first Intensive Outpatient Care to youth and young adults. I lead the
    data engineering team. As a team, we deliver reporting and access to data,
    merging data from the EHR, Qualtrics, Salesforce, and custom developed
    applications to drive clinical outcomes and patient success.  
  \end{position}
