...
%  \vspace{.01in}
  ...
  \begin{position}
    ...
    manual-first data workflow driven by Google Sheets, to a more automated data
    flow using Snowflake and BI tools such as Tableau. By providing automated
    access to the data and reporting, we gave the operations team the time they
    needed to actually lead the operation of the company. 
    
    Data sources included the Charlie Health EHR, Qualtrics, Salesforce, and
    custom developed applications to drive clinical outcomes and patient
    success.  
  \end{position}
  ...
  \location{Troy, NY}
  \begin{position}
    Acuitas was a population health services organization which helped
    independent primary care providers succeed in value based contracts with
    health insurance companies. 
    
    During my five years at Acuitas, I lead the implementation of data-driven
    services and products for Acuitas Health. I hired the team, trained them in
    our process and procedures, I developed the processes and procedures, and I
    played an important role in deciding what technologies to implement and
    when. I was the first manager of the Department of Data Science and
    Engineering (DDSE). DDSE was responsible for the entire analytics stack. On
    the engineering side we were responsible for all of the ETL processes which
    fed data into our data warehouse. On the analytics side, we were responsible
    for interpreting the data, answering stakeholder questions, and developing
    statistical and machine learning models to improve care for patients.

    Data sources included EHRs throughout the Capital District, billing data
    from multiple provider groups, claims data from multiple payer groups,
    custom data sets from products and infrastructure used by specific provider groups.
  \end{position}
  ...
  \begin{position}
    ...
    welfare, elder care, juvenile justice, and mental health. As a policy
    analyst, I was responsible for developing research hypotheses and
    methodologies. I was also responsible for providing support and mentoring to
    junior staff. Other responsibilities include data collection, management and
    analysis of research data and dissemination of results.
