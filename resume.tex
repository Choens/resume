...
%  \vspace{.01in}
  ...
  \begin{position}
    ...
    physicians and physician practices succeed. In my role as lead
    Data Scientist, responsibilities include development of the
    Acuitas Data Warehouse and collaborating with domain experts to
    develop physician risk scores and quality outcomes.
  \end{position}
